...
public class p018_67_max_path_sum {
    public static void main(String[] args) throws IOException {
        BufferedReader reader = new BufferedReader(new InputStreamReader(p018_67_max_path_sum.class.getResourceAsStream("project_euler/p067_triangle.txt")));
